    ...
    return(
        <div className="flex flex-col-reverse md:flex-row justify-center items-center md:my-32 my-30 ml-5 mr-5">
            <div className="flex flex-col">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start mt-4 text-xl">
                    <a href="#" className="btn btn-secondary md:btn-md text-white font-bold text-lg">
                        <Mail />
                        Mail
                    </a>
                    <a href="https://github.com/mathias-pg" className="btn btn-secondary md:btn-md text-white font-bold text-lg">
                        <Github />
                        Github
                    </a>
                    <a href="https://www.linkedin.com/in/mathias-petibon-gravier/" className="btn btn-secondary md:btn-md text-white font-bold text-lg">
                        <Linkedin />    
                        Linkedin
                    </a>
                    <a href="https://www.instagram.com/_mathias.pg_?igsh=dXBmb3F4enA4bnRp" className="btn btn-secondary md:btn-md text-white font-bold text-lg">
                        <Instagram />
                        Instagram
                    </a>
                </div>
